...
namespace Xenoide {
    FolderBrowserGtk::FolderBrowserGtk() {
        ...
        // m_treeView.get_selection()->signal_changed().connect(sigc::mem_fun(*this,
        // &FolderBrowserGtk::OnItemSelected));
    ...
    Gtk::TreeModel::iterator FolderBrowserGtk::appendPathTreeNode(const TreeItemId itemId,
